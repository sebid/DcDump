...
if __name__ == "__main__":
	...
	thread = WorkerThread(r"D:\Program Files (x86)\Games\Anarchy Online", "AlienBank", r"D:\Program Files (x86)\Games\Anarchy Online\\prefs\marenfroob\Char2965624700\Chat\Windows\WindowDCDump\log.txt", tasks, feedback, False)
	thread.start()
